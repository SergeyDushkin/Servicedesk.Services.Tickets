...
namespace servicedesk.Services.Tickets.Framework
{
    ...
    {
        private ILifetimeScope baseApplicationContainer { get; set; }

        public AutofacNancyBootstrapper(ILifetimeScope container = null)
        {
            baseApplicationContainer = container;
        }
        ...
        {
            return baseApplicationContainer ?? new ContainerBuilder().Build();
        }
